...
! function ($, options) {
    ...
    var Utils = function (options) {
        ...
        function tagIsYouTubeVideo(tag) {
            var src = tag.src || '';
            return src.indexOf('youtube.com/embed/index.html') > -1 || src.indexOf('youtube.com/v/index.html') > -1;
        }
        ...
        function normalizeYouTubeIframe(tag) {
            ...
            if (tag.type === 'application/x-shockwave-flash') {
                ...
                tmpPathname = tmpPathname.replace('v/index.html', 'embed/index.html');
        ...
        function tagIsVimeoVideo(tag) {
            var src = tag.src || '';
            return src.indexOf('player.vimeo.com/video/index.html') > -1;
        }
